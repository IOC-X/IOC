...
<div class="btn-group btn-group-justified">
    <a href="managers/list_managers" class="btn btn-default">
            <div class="icon-preview"><i class="mdi-action-account-circle"></i>
            </div>
    Manager List</a>

    <a href="managers/add_managers" class="btn btn-default">
    ...
    <a href="managers/database_managers" class="btn btn-default">
