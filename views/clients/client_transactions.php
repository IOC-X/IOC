...
<form class="form-horizontal" method="post" action="clients/insertTranactions" id="clienttrasactions">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <input type="text" class="form-control" id="client_pump_by" placeholder="" name="client_pump_by"  title="Use Only Letters" pattern="[A-Za-z]{1,}" >
            </div>
        </div>        
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <input type="text" class="form-control" placeholder="Rs: " id="client_pump_liters"  name="client_pump_liters" title="Eg : 0 to 1000" >
            </div>
        </div> 
